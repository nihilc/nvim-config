return {
    {
        ...
        keys = {
            ...
            {"<leader>hk", function() require('telescope.builtin').keymaps()    end, desc = "(H)elp (K)eymaps"},
            {"<leader>tt", function() require('telescope.builtin').builtin()    end, desc = "(T)oggle (T)Telescope"},
        },
